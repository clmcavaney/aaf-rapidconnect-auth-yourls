...
// where to redirect to after successful login (which will invoke this code again I guess)
...
/*
			$auth_url = AAF_RAPIDCONNECT_AUTH_URL;
...
//	preg_grep("/^staff@/", explode(";", $aaf_attributes['edupersonscopedaffiliation']));
	...
	// old method using array above - but this isn't great as it means the plugin has to be updated each time
//	return ( in_array( $aaf_attributes[AAF_ATTRIBUTE_USER], $authorised_users ) ); 
	return ( $valid_user ); 
}
